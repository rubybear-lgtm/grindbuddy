...
export default function Welcome() {
    ...
    return (
        <div className="relative min-h-screen overflow-x-hidden bg-background font-sans selection:bg-primary/20">
            ...
            <main>
                {/* Hero */}
                <header className="relative overflow-hidden pb-40 pt-20 md:pb-60 md:pt-32">
                    <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12">
                            <div
                                className={`space-y-12 transition-all duration-700 lg:col-span-7 ${loaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}
                            >
                            ...
                            {/* Radar chart card */}
                            <div className="relative lg:sticky lg:top-32 lg:col-span-5">
                                <div className="absolute -inset-20 -z-10 animate-pulse rounded-full bg-primary/10 opacity-40 blur-[120px]" />
                                <div className="rounded-[3rem] border border-border bg-card p-10 shadow-2xl md:p-12">
                                    ...
                                    <div className="mt-8 flex items-center justify-between rounded-3xl border border-border bg-muted/50 p-6">
                ...
                {/* How it works */}
                <section id="how-it-works" className="relative py-40 md:py-60">
                    <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            {features.map((item) => (
                                <div
                                    key={item.title}
                                    className="group rounded-[2.5rem] border border-border bg-card p-10 transition-all hover:border-primary/30 hover:bg-muted/50"
                                >
                                    <div className="space-y-6">
                                        <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-border bg-background text-muted-foreground transition-all group-hover:scale-110 group-hover:border-primary/30 group-hover:bg-primary/10 group-hover:text-primary">
                ...
                {/* Problem sets */}
                <section id="problem-sets" className="relative py-40 md:py-60">
                    ...
                    <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {problemSets.map((set) => (
                                <div
                                    key={set.label}
                                    className="group relative overflow-hidden rounded-[2.5rem] border border-border bg-card p-10 transition-all hover:border-primary/30"
                                >
            ...
            {/* Footer */}
            <footer className="border-t border-border bg-card py-24 md:py-32">
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="mt-16 flex flex-col items-center gap-8 border-t border-border/50 pt-12">
