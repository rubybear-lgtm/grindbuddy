...
import { Activity, Brain, Clock, Play, Zap } from 'lucide-react';
                        ...
                        <div className="relative z-10 flex h-full flex-col">
                            <div className="max-w-lg space-y-8">
                                ...
                                <div className="flex flex-wrap gap-6 pt-4">
                                    <Button
                                        size="lg"
                                        className="h-18 !rounded-md bg-primary px-12 text-xl !font-black tracking-widest text-primary-foreground shadow-[0_0_50px_oklch(var(--primary)/0.3)] transition-all hover:scale-105 disabled:opacity-40"
                                    ...
                                    <Button
                                        variant="ghost"
                                        className="h-18 !rounded-md border border-border px-10 text-lg !font-black tracking-widest text-foreground hover:bg-muted"
                                        onClick={() => openLog()}
                                    >
                                        Log a problem
                                    </Button>
